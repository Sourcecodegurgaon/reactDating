  ...
  const showmoresearchResult = async () => {
    ...
    else
    {
      ...
      else
      {
        ...
        props.navigation.navigation.navigate('SearchItems',{ minage:Minage  ,Maxage:Maxage , gender:genderValue, meet:looking, activity:selectedItems ,within:within})
            ...
            <View style={{ paddingHorizontal:10}}>
              ...
              {search ? (
                <View style={styles.secondContainer}>
                  ...
                  {/* <View style={styles.ageContainer}>
                    <View style={styles.postocdeField}>
                      <Text style={styles.headinglabelText}>within : </Text>
                    </View>
                    <View style={styles.AgeFields}>
                      <View>
                      ...
                      <TextInput
                        style={{ borderColor: 'gray', borderBottomWidth: 1 ,width:60}}
                        onChangeText={text => Setwithin(text)}
                        value={within}
                      />
                      </View>
