...
const MonthlySubConfirmation = props => {
        ...
        if (UserDetail != null) {
            ...
            if(response.data.field_subcriptiontype.length == undefined)
            {
                ...
                if(response.data.field_subcriptiontype.und[0].value == "Yearly")
                {
                    ...
                    setenNewSub(Moment(response.data.field_subscriptionenddate.und[0].value).add(1, 'months').format('DD/MM/yyyy'))
 ...
 const updateSubscription = () =>{
    AsyncStorage.getItem('Token', (err, result) => {
        ...
        Http.put('user/' + userId, {
            field_subcriptiontype: { und:[{  value:"Monthly"}] },
            field_subscriptionenddate:{und:[{  value: Moment(response.data.field_subscriptionenddate.und[0].value).add(1, 'months')}]},
...
export default MonthlySubConfirmation