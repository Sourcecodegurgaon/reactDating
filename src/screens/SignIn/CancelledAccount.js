    ...
    const updateSubscription = () =>{
        AsyncStorage.getItem('Token', (err, result) => {
            ...
            Http.put('user/' + userId, {
                field_useraccountclosed:{und:[{value:"true"}]}
            ...
            <ScrollView>
                <TouchableOpacity style={styles.imageContainer} onPress={LogOut}>
                    ...
                    <View style={styles.thirdContainer}>
                        <Text style={styles.upperHeading}>Your account is permanently closed.</Text>
                        ...
                        <Button containerStyle={{ marginHorizontal: 5, marginVertical: 5 ,paddingBottom:10}}
                            onPress={LogOut}
                            title="Ok"
